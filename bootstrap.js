...
function wrappedExpress(...args){
  ...
  app.get('/',async(req,res)=>{
    ...
    html=html.replace('</head>','<link rel="stylesheet" href="/premium-theme.css"></head>');
    html=html.replace('</body>','<script src="/slider-live.js"></script><script src="/hero-live.js"></script><script src="/content-live.js"></script><script src="/ordering.js"></script><script src="/category-live.js"></script><script src="/category-style.js"></script><script src="/location-map.js"></script><script src="/site-cleanup.js"></script><script src="/premium-ui.js"></script></body>');
